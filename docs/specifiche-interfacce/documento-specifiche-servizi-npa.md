...
| Modulo | Contesto | Servizio | Ruolo | 
  ...
  |**Modulo NPA**|**gestioneAppalti**| modifica-scheda-simog  | RP |
...
- modifica-scheda-simog: servizio che consente la modifica di una scheda dati per un appalto migrato da SIMOG.
