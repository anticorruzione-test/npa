...
Tutti i modelli dati sono presenti nel file [modello-dati-fvoe-fva.yaml](https://github.com/anticorruzione-test/npa/tree/refactoringSA/docs/modello-dati/modello-dati-fvoe-fva.yaml)
