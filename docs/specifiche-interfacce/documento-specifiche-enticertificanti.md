...
Tutti i modelli dati sono presenti nel file [modello-dati-fvoe-fva.yaml](https://github.com/anticorruzione-test/npa/tree/changelog06/docs/modello-dati/modello-dati-fvoe-fva.yaml)
