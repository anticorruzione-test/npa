...
Il certificato aggiornato è disponibile [qui](https://github.com/anticorruzione-test/npa/tree/datetimeFormat/docs/certificato%20SSL)
...
La cartella [modello-dati](/docs/modello-dati/) contenente la definizione dinamica del modello dati referenziato nelle specifiche dei servizi esposti dalla NPA. *Esempio*:
 ```shell
 StatoAppaltoEnum:
   $ref: 'https://raw.githubusercontent.com/anticorruzione-test/npa/datetimeFormat/docs/modello-dati/modello-dati-npa.yaml#/components/schemas/StatoAppaltoEnum'
 ```
